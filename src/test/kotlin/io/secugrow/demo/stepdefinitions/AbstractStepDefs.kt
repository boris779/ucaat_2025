...
import io.secugrow.demo.driverutil.PageNotFoundException
import io.secugrow.demo.driverutil.WebDriverSession
import io.secugrow.demo.driverutil.WebDriverSessionStore
...
fun extractTestIdFromScenarioName(scenarioName: String): String {
    ...
    return runCatching {
        ...
        fail("Scenarioname is not correct formated $scenarioName. Pattern: 'XXXX-99 [Filename]")
    }
